...
jQuery(document).ready(function() {
	jQuery('.audiotact').columnize({width:685, height:295 });
	if ((jQuery('.audiotact .column').size()) > 2) {
		infoScroll = new iScroll('box_text_wrap_audiotact', {
			snap: true,
			momentum: true,
			hScrollbar: false,
			vScrollbar: false
...
<div id="main_tabs_content">
	<div id="box_text_wrap_audiotact" class="scroll_wrapper">
		<div class="box_text_columns audiotact">
			<div><?php
			$infoboxes = audiotact_info::get_from_box('audiotact');
