...
if ($pages > 1) {
	...
	//Event.observe('browse_next','click',function(e){ajaxPut('http://localhost:8888/audiotact1/server/ajax.server.php?page=browse&action=page&browse_id=108&start=14','browse_next');});
?>
