...
jQuery(document).ready(function() {
	jQuery('.esprit_du_libre').columnize({width:685, height:295 });
console.log(jQuery('.esprit_du_libre .column').size());
	infoScroll = new iScroll('box_text_wrap', {
		snap: true,
		momentum: true,
		hScrollbar: false,
		vScrollbar: false
...
<div id="main_tabs_content">
	<div id="box_text_wrap" class="scroll_wrapper">
		<div class="box_text_columns esprit_du_libre">
			<div><?php
			$infoboxes = audiotact_info::get_from_box('esprit_du_libre');
