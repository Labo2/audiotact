...
jQuery(document).ready(function() {
	jQuery('.credits').columnize({width:685, height:295 });		
	if ((jQuery('.credits .column').size()) > 2) {
		infoScroll = new iScroll('box_text_wrap_credits', {
			snap: true,
			momentum: true,
			hScrollbar: false,
			vScrollbar: false
...
<div id="main_tabs_content">
	<div id="box_text_wrap_credits" class="scroll_wrapper">
		<div class="box_text_columns credits">
			<div><?php
			$infoboxes = audiotact_info::get_from_box('credits');
