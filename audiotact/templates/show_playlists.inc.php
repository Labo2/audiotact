...
<?php require Config::get('prefix') . '/templates/list_header_tag.inc.php' ?>
<div id="album_tag_wrap">
	...
	<?php } ?>
	<?php if (!count($object_ids)) { ?><div class="<?php echo flip_class(); ?>"><span class="fatalerror"><?php echo _('Aucune playlist correspondant vos critères'); ?></span></div><?php } ?>
</div>
