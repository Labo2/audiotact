...
/* Nouveautés */
$browse2 = new Browse();
$browse2->set_type('artist');
$browse2->store();

/* Populaire */
$browse3 = new Browse();
$browse3->set_type('artist');
$browse3->store();

/* Tous */
$browse4 = new Browse();
$browse4->set_type('artist');
$browse4->store();

require_once Config::get('prefix') . '/templates/browse_content_artist.inc.php';
require_once Config::get('prefix') . '/templates/show_artist_filter.inc.php';
