...
<div id="show_edit_favorit_playlist">
	<p class="title"><img class="list_puce" src="<?php echo $web_path; ?><?php echo Config::get('theme_path'); ?>/images/icons/comment_puce.png" />ÉDITION DE VOS FAVORIS</p>
	<div id="rightbar">
		<?php require_once Config::get('prefix') . '/templates/user_playlist_tmp.inc.php'; ?>
	</div>
</div><!-- #show_edit_favorit_playlist-->


<?php  /* #show_playlist_submit */
$user_playlists = Playlist::get_playlists_from_session();  
Ajax::start_container('show_playlist_submit');  
...
<div id="footer_filter_catalog">
	<div id="sub_tab_filter">
		<?php Ajax::start_container('playlist_download'); ?>
