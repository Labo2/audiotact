...
(function($, undefined) {
	...
	jPlayerPlaylist = function(cssSelector, playlist, options) {
		...
		this.cssSelector.playlistOpen = this.cssSelector.cssSelectorAncestor + " .jp-playlist-open";
		this.cssSelector.playlistClose = this.cssSelector.cssSelectorAncestor + " .jp-playlist-close";
		...
		$(this.cssSelector.playlistOpen).click(function() {
			var btn = $(this);			
			$('.jp-playlist').slideToggle(function(){
