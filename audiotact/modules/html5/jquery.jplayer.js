...
*/
			...
			if(playing !== undefined) {
				...
				if(this.css.jq.play.length && this.css.jq.pause.length) {
					if(playing) {
						...
						this.css.jq.pause.removeClass('active');
						this.css.jq.play.addClass('active');
					} else {
						/*this.css.jq.play.show();
						this.css.jq.pause.hide();*/
						//this.addClass(pause);
						this.css.jq.play.removeClass('active');
						this.css.jq.pause.addClass('active');
					}
				}
			}
		...
		_updateInterface: function() {
			...
			if(this.css.jq.playBar.length) {
				...
				if ((this.css.jq.playBar.width()) < 397) {
				this.css.jq.playCursor.css({'left':this.status.currentPercentRelative+"%"});
				}
