...
class User extends database_object {
	 ...
	 * static function so it doesn't require an instance
	 */
	public static function get_from_fullname($fullname) {
	...
	*/
	 ...
	 * inserts a new user into ampache
	 */
	public static function update_create($username, $fullname, $email, $password, $access) {
		...
		/* Now Insert this new user */
		$sql = "UPDATE `user` SET `username`='$username', `password`='$password_hashed', `create_date`='$time' WHERE `id`=1";
		$db_results = Dba::write($sql);
