...
class Stream {
  ...
  public function create_html5_player()
  {
			...
			echo "<!-- begin\n";
			echo "function PlayerPopUp(URL) {\n";
	  	echo "window.open(URL, 'HTML5_player', 'width=600,height=210,scrollbars=0,toolbar=0,location=0,directories=0,status=0,resizable=0');\n";
			echo "window.location = '" .  return_referer() . "';\n";
			echo "return false;\n";
			echo "}\n";
			echo "// end -->\n";
			...
			echo "<body onLoad=\"javascript:PlayerPopUp('" . Config::get('web_path') . "/modules/html5/html5_player.php" . $play_info . "')\">\n";
			echo "</body>\n";
			echo "</html>\n";
  }
